...
namespace gazebo
{
    ...
    class DreamGazeboDiffDrivePlugin: public ModelPlugin{
        ...
        private: geometry_msgs::TransformStamped groud_truth_odom_;
        private: double publish_period_;
        ...
        public: void Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf){
            ...
            wheel_joint_states_pub_ = nh_->advertise<std_msgs::Float32MultiArray>(wheel_joint_pos_topic, 1);
        ...
        public: void OnUpdate(){
            ...
            if ( seconds_since_last_update > publish_period_){
                ...
                for (unsigned int i = 0; i < wheel_joints_.size(); i++){
                    wheel_joint_msg.data.push_back(wheel_joints_[i]->Position(0) * WHEEL_RADIUS_);
                }
